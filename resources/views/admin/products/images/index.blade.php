	        	...
	        	<div class="section text-center">
	                <h2 class="title">Imágenes de producto "{{ $product->name }}"</h2>
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <button class="btn btn-primary btn-round">Subir nueva Imágen</button>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form method="post" action="">
                                        ...
                                        <button class="btn btn-danger btn-round">Eliminar imágen</button>
                                        @if ($image->destacada)
                                            <button type="button" class="btn btn-primary btn-fab btn-fab-mini btn-round" rel="tooltip" title="Imágen destacada actualmente">
